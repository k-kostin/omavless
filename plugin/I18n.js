...
var CATALOG = {
  ...
  "native.controls": {"en":"Native connection controls. Other product tools are not yet available here.","ru":"Управление подключением через Rust. Остальные инструменты здесь пока недоступны."},
