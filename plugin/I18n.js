...
var CATALOG = {
  ...
  "native.controls": {"en":"Native connection and profile controls. Import and other product tools are still being migrated.","ru":"Управление подключением и профилями через Rust. Импорт и остальные инструменты ещё переносятся."},
