...
var CATALOG = {
  ...
  "native.probe.dns_failed": {"en":"Server address unresolved","ru":"Адрес сервера не разрешён"},
  "native.probe.https_delay": {"en":"HTTPS · {ms} ms","ru":"HTTPS · {ms} мс"},
  "native.probe.https_failed": {"en":"HTTPS failed or timed out","ru":"Ошибка HTTPS или тайм-аут"},
  "native.probe.test": {"en":"Check HTTPS","ru":"Проверить HTTPS"},
  "native.probe.sort": {"en":"Sort: HTTPS","ru":"Порядок: HTTPS"},
  "native.probe.scope": {"en":"Separate HTTPS checks through these profiles, not ICMP ping or a verdict on the active VPN. Your connection is unchanged.","ru":"Отдельные HTTPS-проверки через эти профили, не ICMP-пинг и не оценка активного VPN. Текущее подключение не меняется."},
  ...
  "native.test.scope": {"en":"Uses current routing, which may be direct. Neither success nor failure proves VPN health or absence of leaks.","ru":"Использует текущий маршрут, возможно напрямую. Ни успех, ни ошибка не доказывают исправность VPN или отсутствие утечек."},
  ...
  "native.onboarding.setup_help": {"en":"If Mihomo or its network permissions are missing, follow the installation guide. After setup, return here and check again; this wizard does not install packages or grant permissions.","ru":"Если Mihomo или сетевые права отсутствуют, следуйте инструкции по установке. Затем вернитесь сюда и проверьте снова: мастер не устанавливает пакеты и не выдаёт права."},
  "native.onboarding.setup_guide": {"en":"Installation guide ↗","ru":"Инструкция по установке ↗"},
  "native.onboarding.import_help": {"en":"Paste a profile or subscription link, or choose a file containing one. You will review it before adding; private links stay in OmaVLESS storage.","ru":"Вставьте ссылку на профиль или подписку либо выберите файл с такой ссылкой. Перед добавлением появится подтверждение; приватные ссылки хранятся в OmaVLESS."},
  "native.onboarding.picker_missing": {"en":"File import unavailable — no supported file picker was found.","ru":"Импорт из файла недоступен — средство выбора файлов не найдено."},
  "native.onboarding.clipboard_missing": {"en":"Clipboard import unavailable — wl-clipboard was not found.","ru":"Импорт из буфера недоступен — wl-clipboard не найден."},
  "native.onboarding.install_clipboard": {"en":"Install clipboard support","ru":"Установить поддержку буфера обмена"},
  "native.onboarding.copy_unavailable": {"en":"Command copying is unavailable. Enter the command in a terminal, then check again.","ru":"Копирование команды недоступно. Введите команду в терминале, затем проверьте снова."},
  "native.onboarding.helpers_unknown": {"en":"Helper availability is unverified. Choose Check again.","ru":"Наличие компонентов не проверено. Нажмите «Проверить снова»."},
  ...
  "native.subscription.fetchFailed": {"en":"Could not download the subscription. Check Internet access and the subscription link. Existing profiles were kept.","ru":"Не удалось скачать подписку. Проверьте доступ к Интернету и ссылку подписки. Существующие профили сохранены."},
  "native.subscription.refreshFailed": {"en":"Subscription refresh did not complete. Check the subscription and current runtime state before trying again.","ru":"Обновление подписки не завершено. Перед повтором проверьте подписку и текущее состояние приложения."},
  "native.subscription.deleteFailed": {"en":"Subscription removal did not complete. Check current runtime state before trying again.","ru":"Удаление подписки не завершено. Перед повтором проверьте текущее состояние приложения."},
  ...
  "native.ping.unavailable": {"en":"ICMP measurement unavailable — not a VPN failure verdict","ru":"Замер ICMP недоступен — это не означает сбой VPN"},
  "native.ping.observed": {"en":"ICMP through TUN. No reply does not prove Internet access is broken or ICMP is blocked.","ru":"ICMP через TUN. Нет ответа — не доказательство сбоя интернета или блокировки ICMP."},
